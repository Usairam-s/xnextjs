          ...
          <div className="p-4">
            ...
            <div className="flex p-3 space-x-3">
              ...
              <div className="w-full divide-y divide-gray-200">
                <div>
                  <textarea
                    className="w-full outline-none border-none tracking-wide min-h-[50px] text-gray-700 placeholder:text-gray-500"
                    rows={"2"}
                ...
                <div className="flex items-center justify-end pt-2 ">
                  <button
                    className="bg-blue-400 text-white font-bold px-4 py-1.5 rounded-full shadow-md hover:brightness-95 disabled:opacity-50 "
                    disabled={input.trim() === ""}
                    onClick={sendComment}
                  >
                    Reply
